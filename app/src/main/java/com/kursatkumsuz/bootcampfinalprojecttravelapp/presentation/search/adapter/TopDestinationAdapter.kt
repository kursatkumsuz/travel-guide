package com.kursatkumsuz.bootcampfinalprojecttravelapp.presentation.search.adapter
...
import com.kursatkumsuz.bootcampfinalprojecttravelapp.presentation.search.SearchFragmentDirections
import com.kursatkumsuz.bootcampfinalprojecttravelapp.util.DiffUtil.Companion.diffUtil
import javax.inject.Inject

class TopDestinationAdapter @Inject constructor(
    private val glide: RequestManager
) : RecyclerView.Adapter<TopDestinationAdapter.TopDestinationHolder>() {

    class TopDestinationHolder(val binding: ListItemTopDestinationBinding) :
